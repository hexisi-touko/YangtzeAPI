...
const (
	...
	MsgTokenAdminIssuedOnly      = "token.admin_issued_only"
)
...
const (
	...
	MsgUserApplicationReasonInvalid        = "user.application_reason_invalid"
	MsgUserApplicationSubmitted            = "user.application_submitted"
	MsgUserApplicationPending              = "user.application_pending"
	MsgUserApplicationRejected             = "user.application_rejected"
	MsgUserApplicationNotFound             = "user.application_not_found"
	MsgUserApplicationAlreadyReviewed      = "user.application_already_reviewed"
	MsgUserApplicationReviewCommentInvalid = "user.application_review_comment_invalid"
	MsgUserApplicationApproved             = "user.application_approved"
	MsgUserApplicationRejectedByAdmin      = "user.application_rejected_by_admin"
